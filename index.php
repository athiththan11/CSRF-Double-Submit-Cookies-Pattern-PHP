                ...
                <div class="row">
                    <div class="col-md-5 mx-auto my-5 align-self-center">
                        ...
                        <p class="text-secondary text-justify">
                            ...
                            built to demonstrate <b>Double Submit Cookies Pattern (DSCP)</b>,
                            where the CSRF token is generated by the server at the start of a user session and stored as
                            a cookie.
                        </p>
                        <p class="text-secondary text-justify">
                    ...
                    <div class="col-md-6 mx-auto align-self-center">
                        <img class="w-100" src="/www/img/dscp_form.png">
                    </div>
